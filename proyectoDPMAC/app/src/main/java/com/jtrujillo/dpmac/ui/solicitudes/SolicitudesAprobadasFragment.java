...
public class SolicitudesAprobadasFragment extends Fragment {
    ...
    private List<Solicitud> obtenerSolicitudes() {
        ...
        solicitudes.add(new Solicitud(
                9, 4, R.drawable.img_casa02, "Casa05",
                "BAJO", "#13CE66", "25/08/2023",
                "S/. 20,000.00", "20.00%", "S/. 100,000.00"
        ));
        solicitudes.add(new Solicitud(
                10, 4, R.drawable.img_departamento02, "Departamento05",
                "MODERADO", "#FFDC5C", "26/08/2023",
                "S/. 25,000.00", "16.67%", "S/. 150,000.00"
        ));
        solicitudes.add(new Solicitud(
                11, 4, R.drawable.img_casa03, "Casa06",
                "MEDIO", "#FF9052", "27/08/2023",
                "S/. 30,000.00", "15.00%", "S/. 200,000.00"
        ));
        solicitudes.add(new Solicitud(
                12, 4, R.drawable.img_departamento03, "Departamento06",
                "BAJO", "#13CE66", "28/08/2023",
                "S/. 40,000.00", "16.00%", "S/. 250,000.00"
        ));
