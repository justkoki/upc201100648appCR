...
public class InversionesEncobranzaFragment extends Fragment {
    ...
    private List<Inversion> obtenerInversiones() {
        ...
        inversiones.add(new Inversion(
                101, 6, R.drawable.img_casa03, "Casa",
                "BAJO", "#13CE66", "#FFFFFF",
                "S/. 2,000.00", "S/. 50,000.00", 12, "1.67% / 20.00%", 100
        ));
        inversiones.add(new Inversion(
                102, 6, R.drawable.img_departamento03, "Departamento",
                "MODERADO", "#FFDC5C", "#FFFFFF",
                "S/. 4,800.00", "S/. 40,000.00", 24, "2.00% / 24.00%", 100
        ));
        inversiones.add(new Inversion(
                103, 6, R.drawable.img_casa02, "Casa",
                "MEDIO", "#FF9052", "#FFFFFF",
